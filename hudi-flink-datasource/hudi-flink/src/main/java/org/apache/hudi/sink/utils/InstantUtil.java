...
public class InstantUtil {
  ...
  /**
   * get instant file id from marker file
   * @param markerFilePath
   * @return
   */
  public static String getFileIdFromFile(String markerFilePath) {
    if (markerFilePath.contains("/")) {
      markerFilePath = markerFilePath.substring(markerFilePath.lastIndexOf("/") + 1);
    }
    return FSUtils.getFileId(markerFilePath);
  }
}
